...
class AgentPropertiesController extends Controller
{
    public function index(){
        ...
        return view('pages.agent.properties.index', compact('properties'));
    }
    ...
    public function create(){
        ...
        return view('pages.agent.properties.create', compact('properties', 'locations', 'types'));
    }
    public function edit($id){
        $locations = Location::all();
        $types = Type::all();
        $properties = Properties::findOrFail($id);
        return view('pages.agent.properties.edit', compact('properties', 'locations', 'types'));
    }
    public function show($id){
        $properties=Properties::findOrFail($id);
        return view('pages.agent.properties.show',compact('properties'));
    }
